...
function Dashboard({ date }) {
  ...
  return (
    <>
      ...
      <div className="d-md-flex mb-3 row justify-content-md-center">
        <h3 className="mb-0">{displayDate.display}</h3>
      </div>
      {/* button group (previous, Today, Next, and date picker) */}
      <div className="input-group input-group-sm mb-3 row justify-content-md-center">
      ...
      <div className="d-md-flex mb-3">
        <h4 className="mb-0">Reservations List</h4>
      </div>
      <ErrorAlert error={reservationsError} />
      <div>{displayReservations}</div>
      {/* Tables Section */}
      <div className="d-md-flex mb-3">
        <h4 className="mb-0">Tables List</h4>
      </div>
